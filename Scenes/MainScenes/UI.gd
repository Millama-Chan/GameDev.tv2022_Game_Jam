...
onready var hp_bar = get_node("HUD/InfoBar/BuildBar/HP")
onready var hp_bar_tween = get_node("HUD/InfoBar/BuildBar/HP/Tween")

func _process(_delta):
	get_node("HUD/InfoBar/BuildBar/Money/Label").text = str(GameData.cash)
...
func set_tower_preview(tower_type, mouse_position):
	...
	var scaling = GameData.towerdata[tower_type]["range"] / 600.0
